...
<br>
Apple Crumble is an augmented reality mobile game which allows players to go on scavenger hunts in order to complete quests and earn badges. Partially inspired by Pokemon Go and Maplestory, it was designed to evoke back the memories. The player can receive quests from digitally-rendered NPCs and are asked to find items that advance the in-game storyline. Players point their phone's cameras at the items they need to find, and the Vuforia AR camera responds to the correct matching targets. Users are able to log in, keep track of the badges they earned in their badge box. Users also can recieve hints as well as check their quest log for more information about their quest.
